...
umap_model = UMAP(n_neighbors=3, n_components=5, min_dist=0.1, metric='cosine', random_state=SEED)
...
# Loop de treinamento
CLUSTER_SIZES = list(range(5, 55, 5))
results = []
